    ...
    <div class="main-content-inner">
        <div class="page-content">
            ...
            <div class="row" style="font-family: 'Times New Roman', Times, serif">
                <form:form modelAttribute="customerEdit" method="get" action="/admin/customer-edit" name="formEdit" class="form-horizontal" id="form-edit">
                    <div class="col-xs-12">
                        <div class="form-group">
                            <label class="col-xs-3">Tên khách hàng</label>
                            <div class="col-xs-9">
                                <form:input path="fullName" class="form-control" required="required" placeholder="bắt buộc"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-3">Số điện thoại</label>
                            <div class="col-xs-9">
                                <form:input path="phone" class="form-control" required="required" placeholder="bắt buộc"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                ...
                                <c:if test="${not empty customerEdit.id}">
                                    <sec:authorize access="hasRole('ROLE_MANAGER')">
                                        <button class="btn btn-primary" id="btnUpdateCustomer" onclick="editCustomer(${customerEdit.id})">
                                            Sửa thông tin khách hàng
                                        </button>
                                    </sec:authorize>
                                </c:if>
                                <a class="btn btn-primary" href="./customer-list">Hủy thao tác</a>
                            </div>
                        </div>
                    </div>
                </form:form>
