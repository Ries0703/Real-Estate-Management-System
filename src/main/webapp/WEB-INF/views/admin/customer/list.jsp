    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="page-header">
                <h1 style="font-weight: normal; font-family: 'Times New Roman', Times, serif;">Danh sách khách hàng</h1>
            </div>
            <!-- /.page-header -->
                        ...
                        <display:column title="Thao tác" media="html">
                            <div>
                                <c:if test="${currentUserRoles.contains('ROLE_MANAGER')}">
                                    ...
                                    <button
                                            data-customer-id="${customerTable.id}"
                                            title="Xóa khách"
                                ...
                                <a
                                        href="/admin/customer-edit-${customerTable.id}"
...
<script>
    ...
    $("#btnDeleteCustomer").click(function (event) {
        event.preventDefault();
        var data = {};
        data["customerIds"] = $("#customerTable")
            .find("tbody input[type=checkbox]:checked")
            .map(function () {
                return $(this).val();
            })
