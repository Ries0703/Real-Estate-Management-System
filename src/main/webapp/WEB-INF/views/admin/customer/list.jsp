        ...
        <div class="page-content">
                    ...
                    <div class="widget-box" style="font-family: 'Times New Roman', Times, serif">
                        <div class="widget-header">
                            <h4 class="widget-title"
                                style="font-weight: normal; font-family: 'Times New Roman', Times, serif;">
                                Tìm kiếm
                            </h4>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <form:form id="listForm" method="GET" action="/admin/customer-list"
                                           modelAttribute="customerSearchRequest">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="number" class="form-control" name="phone"
                                                           value="${customerSearchRequest.phone}"/>
                                                </div>
                                                <div class="col-sm-4">
                                                    <label>Email</label>
                                                    <input type="email" class="form-control" name="email"
                                                           value="${customerSearchRequest.email}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
            ...
            <div class="col-xs-12">
                <form action="<c:url value='/admin/customer-list'/>" id="formSubmit" method="get">
                    <display:table id="customerTable" name="${customerList}"
                                   class="table table-striped table-bordered table-hover"
                                   requestURI="/admin/customer-list" keepStatus="true">
                        <sec:authorize access="hasRole('ROLE_MANAGER')">
                            <display:column
                                    ...
                                    media="html" headerClass="center">
                                <label class="pos-rel">
                                    <input type="checkbox" class="ace" name="customer-checkbox"
                        ...
                        <display:column title="Thao tác" media="html">
                            <div>
                                <sec:authorize access="hasRole('ROLE_MANAGER')">
                                    <button title="Giao khách" class="btn btn-sm btn-success"
                                            onclick="assignmentCustomer(${customerTable.id})"
                                            name="assignmentCustomerBtn">
                                    ...
                                    <button data-customer-id="${customerTable.id}" title="Xóa khách"
                                            class="btn btn-sm btn-danger btnDeleteOneCustomer">
                                        <i class="ace-icon glyphicon glyphicon-trash"></i>
                                    </button>
                                </sec:authorize>
                                <a href="/admin/customer-edit-${customerTable.id}" class="btn btn-sm btn-info"
