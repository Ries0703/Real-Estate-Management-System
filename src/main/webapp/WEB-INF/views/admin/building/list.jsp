        ...
        <div class="page-content">
                ...
                <div class="col-xs-12">
                    <div class="widget-box" style="font-family: 'Times New Roman', Times, serif">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <form:form id="listForm" method="GET" action="/admin/building-list" modelAttribute="buildingSearchRequest">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="number" class="form-control" name="floorArea" value="${buildingSearchRequest.floorArea}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="number" class="form-control" name="numberOfBasement" value="${buildingSearchRequest.numberOfBasement}"/>
                                                </div>
                                                <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="number" class="form-control" name="level" value="${buildingSearchRequest.level}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="number" class="form-control" name="areaFrom" value="${buildingSearchRequest.areaFrom}"/>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label for="name">Diện tích đến</label>
                                                    <input type="number" class="form-control" name="areaTo" value="${buildingSearchRequest.areaTo}"/>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label for="name">Giá thuê từ</label>
                                                    <input type="number" class="form-control" name="rentPriceFrom" value="${buildingSearchRequest.rentPriceFrom}"/>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label for="name">Giá thuê đến</label>
                                                    <input type="number" class="form-control" name="rentPriceTo" value="${buildingSearchRequest.rentPriceTo}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <input type="number" class="form-control" name="managerPhone" value="${buildingSearchRequest.managerPhone}"/>
                                                </div>
                                                <div class="col-sm-2">
                    ...
                    <sec:authorize access="hasRole('ROLE_MANAGER')">
                        <div class="pull-right">
                            ...
                            <button title="Xóa tòa nhà" class="btn btn-danger" id="btnDeleteBuilding">
            ...
            <div class="col-xs-12">
                <form action="<c:url value='/admin/building-list'/>" id="formSubmit" method="get">
                    <display:table id="buildingTable" name="${buildingList}" class="table table-striped table-bordered table-hover" requestURI="/admin/building-list" keepStatus="true">
                        <sec:authorize access="hasRole('ROLE_MANAGER')">
                            <display:column title="<label class='pos-rel'><input type='checkbox' class='ace' id='selectAllCheckboxBuilding' onclick='toggle(this)'/><span class='lbl'></span></label>" media="html" headerClass="center">
                                <label class="pos-rel">
                                    <input type="checkbox" class="ace" name="building-checkbox" value="${buildingTable.id}"/>
                                    <span class="lbl"></span>
                                </label>
                            </display:column>
                        </sec:authorize>
                        ...
                        <display:column title="Thao tác" media="html">
                            <div>
                                <sec:authorize access="hasRole('ROLE_MANAGER')">
                                    <button title="Giao tòa nhà" class="btn btn-sm btn-success" onclick="assignmentBuilding(${buildingTable.id})" name="assignmentBuildingBtn">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/>
                                        </svg>
                                    </button>
                                    <button data-building-id="${buildingTable.id}" title="Xóa tòa nhà" class="btn btn-sm btn-danger btnDeleteOneBuilding">
                                        <i class="ace-icon glyphicon glyphicon-trash"></i>
                                    </button>
                                </sec:authorize>
                                <a href="/admin/building-edit-${buildingTable.id}" class="btn btn-sm btn-info" title="Sửa tòa nhà">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="btnAssignBuilding">
                        Giao tòa nhà
                    </button>
